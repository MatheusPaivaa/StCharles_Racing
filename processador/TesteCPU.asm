...
;	2) Onde Comeca: Pegar gcc o que tem que fazer e ir voltando até chegar em um registrador (ie. PC)
;	3) Qual é a Sequencia de Operacoes: Descrever todos os comandos que tem que dar nos cilos de Dec e Exec
;	4) Já terminou??? Cumpriu o que tinha que fazer??? O PC está pronto para a proxima instrucao (cuidado com Load, Loadn, Store, Jmp, Call)
